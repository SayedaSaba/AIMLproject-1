...
classifier = cv2.CascadeClassifier(
    r'C:/Users/Asus/Desktop/FACE_DETECT/FACE_DETECT/haarcascade_frontalface_default.xml'
)

# Your trained face-recognition model (CNN)
model = load_model(
    r"C:/Users/Asus/Desktop/FACE_DETECT/FACE_DETECT/final_model.h5"
)

# URL of your IP Camera (IP Webcam app)
URL = 'http://192.168.189.46:8080/shot.jpg'
...
def get_pred_label(pred):
    ...
    labels = ["bishal"]    # Add more names if you train multiple people
    return labels[pred]
