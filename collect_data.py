...
import urllib.request                  # To read image from an online URL
import numpy as np             # For array operations

# Load the Haarcascade face detection model
# This file helps OpenCV identify human faces in an image
classifier = cv2.CascadeClassifier(
    r"C:\Users\SAYEDA SABA\OneDrive\Desktop\projects\haarcascade_frontalface_default.xml"
)

# IP Webcam link (from your mobile camera app)
url = "http://10.122.31.82:8080/shot.jpg"
